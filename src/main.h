...
static const int LAST_POW_BLOCK = 126000000; //about 10,000 Years of PoW blocks
...
static const uint256 hashGenesisBlock("0x00000eb2c92a05e82d2b6a4ee517597b916ceebf6d7e4aaa8d7b9601a72aaaf2");
static const uint256 hashGenesisBlockTestNet("0x00000eb2c92a05e82d2b6a4ee517597b916ceebf6d7e4aaa8d7b9601a72aaaf2");
...
public:
    ...
    {
        // NES: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // NES: get transaction coin age
...
public:
    ...
    // NES: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // NES: two types of block: proof-of-work or proof-of-stake
    ...
    // NES: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // NES: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // NES: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // NES: block index flags
    enum  
    {
